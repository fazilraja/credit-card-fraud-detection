...
class DecisionTree:
    ...
    Parameters:
    - min_samples_split (int): The minimum number of samples required to split a node. Default value is 2.
    - max_depth (int): The maximum depth of the tree. Default value is 100.
    """
